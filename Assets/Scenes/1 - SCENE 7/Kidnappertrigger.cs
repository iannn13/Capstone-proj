...
public class Kidnappertrigger : MonoBehaviour
{
    [Header("Ink JSON")]
    ...
    private void Start()
    {
        ...
        KidnapperDialogue.GetInstance().OnDialogueComplete += OnKidnapperDialogueComplete;
    }
    ...
    private IEnumerator StartDialogueAfterDelay()
    {
        if (!dialogueStarted)
        {
            ...
            KidnapperDialogue.GetInstance().EnterDialogueMode(inkJSON);
        }
    }
    ...
    private void OnKidnapperDialogueComplete()
    {
