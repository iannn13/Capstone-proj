...
public class PoliceTriggerC3 : MonoBehaviour
{
    [Header("Ink JSON")]
    ...
    private void Start()
    {
        ...
        PoliceDial.GetInstance().OnDialogueComplete += OnPoliceDialComplete;
    ...
    private IEnumerator StartDialogueAfterDelay()
    {
        if (!dialogueStarted)
        {
            ...
            PoliceDial.GetInstance().EnterDialogueMode(inkJSON);
        }
    }
    ...
    private void OnPoliceDialComplete()
    {
