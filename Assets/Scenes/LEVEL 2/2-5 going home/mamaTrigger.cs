...
public class mamaTrigger3 : MonoBehaviour
{
    [Header("Ink JSON")]
    ...
    private void Start()
    {
        ...
        mamaDial.GetInstance().OnDialogueComplete += OnmamaDialComplete;
    ...
    private IEnumerator StartDialogueAfterDelay()
    {
        if (!dialogueStarted)
        {
            ...
            mamaDial.GetInstance().EnterDialogueMode(inkJSON);
        }
    }
    ...
    private void OnmamaDialComplete()
    {
