...
public class KidnapperTrigger1 : MonoBehaviour
{
    [Header("Ink JSON")]
    ...
    private void Start()
    {
        ...
        KidnapperDialogue1.GetInstance().OnDialogueComplete += OnKidnapperDialogue1Complete;
    ...
    private IEnumerator StartDialogueAfterDelay()
    {
        if (!dialogueStarted)
        {
            ...
            KidnapperDialogue1.GetInstance().EnterDialogueMode(inkJSON);
        }
    }
    ...
    private void OnKidnapperDialogue1Complete()
    {
