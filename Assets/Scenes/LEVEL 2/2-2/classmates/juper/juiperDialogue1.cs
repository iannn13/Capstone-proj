...
public class juperDialogue1 : MonoBehaviour
{
    ...
    [SerializeField] private GameObject juper;
    [SerializeField] private GameObject jupername;
    [SerializeField] private GameObject justine;
    [SerializeField] private GameObject justinename;

    private Story currentStory;
    public bool dialogueIsPlaying { get; private set; }

    private static juperDialogue1 instance;
    ...
    public static juperDialogue1 GetInstance()
    {
        return instance;
    }
    ...
    private void ContinueStory()
    {
        if (currentStory.canContinue)
        {
                ...
                if (storyText.Contains("Greetings, Juper's Dad."))
                {
                    you.gameObject.SetActive(true);
                    youname.gameObject.SetActive(true);
                    juper.gameObject.SetActive(false);
                    jupername.gameObject.SetActive(false);
                    justine.gameObject.SetActive(false);
                    justinename.gameObject.SetActive(false);
                }
                else if (storyText.Contains("That's just my classmate, Aris.") || storyText.Contains("Bye, Aris..."))
                {
                    you.gameObject.SetActive(false);
                    youname.gameObject.SetActive(false);
                    juper.gameObject.SetActive(true);
                    jupername.gameObject.SetActive(true);
                    justine.gameObject.SetActive(false);
                    justinename.gameObject.SetActive(false);
                }
                else
                {
                    ...
                    juper.gameObject.SetActive(false);
                    jupername.gameObject.SetActive(false);
                    justine.gameObject.SetActive(true);
                    justinename.gameObject.SetActive(true);
                }
        ...
        else
        {
            ...
            {
                transitionManager.FadeToScene(14);
            }
            else
            {
