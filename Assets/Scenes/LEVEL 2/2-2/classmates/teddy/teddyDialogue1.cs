...
public class teddyDialogue1 : MonoBehaviour
{
    ...
    private static teddyDialogue1 instance;
    ...
    public static teddyDialogue1 GetInstance()
    {
        return instance;
    }
    ...
    private void ContinueStory()
    {
        if (currentStory.canContinue)
        {
            if (currentStory.canContinue)
            {
                ...
                if (storyText.Contains("What do you want to do today?"))
                {
