...
public class NeneTrigger1 : MonoBehaviour
{
    [Header("Ink JSON")]
    ...
    private void Start()
    {
        ...
        NeneDialogue1.GetInstance().OnDialogueComplete += OnCatDialogueComplete;
    ...
    private IEnumerator StartDialogueAfterDelay()
    {
        if (!dialogueStarted)
        {
            ...
            NeneDialogue1.GetInstance().EnterDialogueMode(inkJSON);
        }
    }
