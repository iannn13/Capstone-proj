...
public class IanTrigger : MonoBehaviour
{
    [Header("Ink JSON")]
    ...
    private void Start()
    {
        ...
        IanDialogue.GetInstance().OnDialogueComplete += OnCatDialogueComplete;
    ...
    private IEnumerator StartDialogueAfterDelay()
    {
        if (!dialogueStarted)
        {
            ...
            IanDialogue.GetInstance().EnterDialogueMode(inkJSON);
        }
    }
