...
public class nenepinangTrigger : MonoBehaviour
{
    [Header("Ink JSON")]
    ...
    private void Start()
    {
        ...
        nenepinangDial.GetInstance().OnDialogueComplete += OnCatDialogueComplete;
    ...
    private IEnumerator StartDialogueAfterDelay()
    {
        if (!dialogueStarted)
        {
            ...
            nenepinangDial.GetInstance().EnterDialogueMode(inkJSON);
        }
    }
