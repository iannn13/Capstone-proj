...
public class nenepinangDial : MonoBehaviour
{
    ...
    [SerializeField] private GameObject ninaname;
    [SerializeField] private GameObject pinangpic;
    [SerializeField] private GameObject pinangname;

    private Story currentStory;
    public bool dialogueIsPlaying { get; private set; }

    private static nenepinangDial instance;
    ...
    public static nenepinangDial GetInstance()
    {
        return instance;
    }
    ...
    private void Start()
    {
        ...
        pinangname.gameObject.SetActive(false);
        pinangpic.gameObject.SetActive(false);
        ninapic.gameObject.SetActive(false);
        ninaname.gameObject.SetActive(false);
    ...
    private void ContinueStory()
    {
         if (currentStory.canContinue)
        {
                ...
                if (storyText.Contains("I’m so scared for Teddy, I hope he comes back.") ||
                 storyText.Contains("We should hold hands so no one can get us!"))
                {
                    pinangname.gameObject.SetActive(false);
                    pinangpic.gameObject.SetActive(false);
                    ninapic.gameObject.SetActive(true);
                    ninaname.gameObject.SetActive(true);
                }
                else
                {
                pinangname.gameObject.SetActive(true);
