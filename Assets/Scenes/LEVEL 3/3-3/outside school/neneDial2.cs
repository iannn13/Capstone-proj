...
public class neneDial2 : MonoBehaviour
{
    ...
    [Header("name and pic")]
    [SerializeField] private GameObject nenepic;
    [SerializeField] private GameObject nenename;
    ...
    private static neneDial2 instance;
    ...
    public static neneDial2 GetInstance()
    {
        return instance;
    }
    ...
    private void Start()
    {
        ...
        nenename.gameObject.SetActive(false);
        nenepic.gameObject.SetActive(false);
    ...
    private void ContinueStory()
    {
        if (currentStory.canContinue)
        {
            ...
            if (storyText.Contains("Mommy, will you ever find our classmate?"))
            {
                policename.gameObject.SetActive(false);
                policepic.gameObject.SetActive(false);
                nenepic.gameObject.SetActive(true);
                nenename.gameObject.SetActive(true);
            }
            else
            {
