...
public class WarsakTrigger : MonoBehaviour
{
    [Header("Ink JSON")]
    ...
    private void Start()
    {
        ...
        WarsakDial.GetInstance().OnDialogueComplete += OnWarsakDialComplete;
    ...
    private IEnumerator StartDialogueAfterDelay()
    {
        if (!dialogueStarted)
        {
            ...
            WarsakDial.GetInstance().EnterDialogueMode(inkJSON);
        }
    }
