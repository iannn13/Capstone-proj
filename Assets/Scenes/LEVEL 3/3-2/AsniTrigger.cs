...
public class AsniTrigger : MonoBehaviour
{
    [Header("Ink JSON")]
    ...
    private void Start()
    {
        ...
        AsniDialogue.GetInstance().OnDialogueComplete += OnCatDialogueComplete;
    ...
    private IEnumerator StartDialogueAfterDelay()
    {
        if (!dialogueStarted)
        {
            ...
            AsniDialogue.GetInstance().EnterDialogueMode(inkJSON);
        }
    }
