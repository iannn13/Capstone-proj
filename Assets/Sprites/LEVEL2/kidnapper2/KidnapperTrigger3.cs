...
public class KidnapperTrigger3 : MonoBehaviour
{
    [Header("Ink JSON")]
    ...
    private void Start()
    {
        ...
        KidnapperDial3.GetInstance().OnDialogueComplete += OnCatDialogueComplete;
    ...
    private IEnumerator StartDialogueAfterDelay()
    {
        if (!dialogueStarted)
        {
            ...
            KidnapperDial3.GetInstance().EnterDialogueMode(inkJSON);
        }
    }
